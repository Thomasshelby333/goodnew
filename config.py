...
AUTH_CHANNEL = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('AUTH_CHANNEL', '-1002299135622').split()] # give channel id with seperate space. Ex : ('-10073828 -102782829 -1007282828')
...
DB_URI = environ.get("DB_URI", "mongodb+srv://hariv1323:iamdevill@iamdevil.qu3nabh.mongodb.net/?retryWrites=true&w=majority&appName=iamdevil")
DB_NAME = environ.get("DB_NAME", "iamdevil")
...
SHORTLINK_API = environ.get("SHORTLINK_API", "82db8582c8122d781745b56ea24d3b8dcdfefb09") # shortlink api
VERIFY_TUTORIAL = environ.get("VERIFY_TUTORIAL", "https://t.me/+pVPv69822bhmMmZl") # how to open link 

# Website Info:
WEBSITE_URL_MODE = bool(environ.get('WEBSITE_URL_MODE', False)) # Set True or False

# If Website Url Mode Is True Then Fill All Required Variable, If False Then Don't Fill.
WEBSITE_URL = environ.get("WEBSITE_URL", "https://t.me/tamil_movie_link1") # For More Information Check Video On Yt - @Tech_VJ
